DROP TABLE IF EXISTS `networkContact`;
CREATE TABLE `networkContact` (
  ...
  , FOREIGN KEY fk_networkContactType(networkContactType) REFERENCES list(recordId) ON UPDATE CASCADE ON DELETE CASCADE
